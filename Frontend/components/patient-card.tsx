        ...
        <div className="flex-1">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                onClick={handleEdit}
                className="inline-flex items-center justify-center px-2 py-1 text-xs rounded-full bg-blue-100 text-blue-700 hover:bg-blue-200 transition-colors"
              ...
              <button
                ...
                disabled={isDeleting}
                className="inline-flex items-center justify-center px-2 py-1 text-xs rounded-full bg-red-100 text-red-700 hover:bg-red-200 transition-colors disabled:opacity-50"
